...
import { R as ReportService, E as EsriJobStatusType } from './report.service.js';
import { r as request, c as cleanUrl, A as ArcGISRequestError, e as encodeQueryString, a as ArcGISAuthError, N as NODEJS_DEFAULT_REFERER_HEADER, U as UtilService } from './util.service.js';
import { T as TranslateService } from './translate.service.js';
import { S as StateService } from './state.service.js';
import { d as defineCustomElement$c } from './detail-table2.js';
import { d as defineCustomElement$b } from './error-detail-modal2.js';
import { d as defineCustomElement$a } from './features-preview2.js';
import { d as defineCustomElement$9 } from './file-option-chooser2.js';
import { d as defineCustomElement$8 } from './report-generator2.js';
import { d as defineCustomElement$7 } from './report-icon2.js';
import { d as defineCustomElement$6 } from './report-settings2.js';
import { d as defineCustomElement$5 } from './success-detail-modal2.js';
import { d as defineCustomElement$4 } from './task-info2.js';
import { d as defineCustomElement$3 } from './task-list2.js';
import { d as defineCustomElement$2 } from './template-chooser2.js';
...
const FeatureReport$1 = /*@__PURE__*/ proxyCustomElement(class FeatureReport extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return FeatureReportStyle0; }
}, [1, "feature-report", {
        "token": [1],
        ...
        "outputReportName": [1, "output-report-name"],
        "outputPackageName": [1, "output-package-name"],
        "packageFiles": [8, "package-files"],
        "uploadInfo": [1, "upload-info"],
        "webmapItemId": [1, "webmap-item-id"],
        "mapScale": [1, "map-scale"],
        "locale": [1],
        "utcOffset": [1, "utc-offset"],
        "show": [1],
        "hide": [1],
        "inputFeatureTemplate": [1, "input-feature-template"],
        "label": [1],
        "reportTemplateIds": [1, "report-template-ids"],
        "clientId": [1, "client-id"],
        "requestSource": [1, "request-source"],
        "where": [32],
        "username": [32],
        "state": [32],
        "visibleConf": [32],
...
function defineCustomElement$1() {
    ...
    const components = ["feature-report", "detail-table", "error-detail-modal", "features-preview", "file-option-chooser", "report-generator", "report-icon", "report-settings", "success-detail-modal", "task-info", "task-list", "template-chooser"];
    components.forEach(tagName => { switch (tagName) {
        case "feature-report":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, FeatureReport$1);
            }
            break;
        case "detail-table":
            if (!customElements.get(tagName)) {
...
const FeatureReport = FeatureReport$1;
const defineCustomElement = defineCustomElement$1;

export { FeatureReport, defineCustomElement };
